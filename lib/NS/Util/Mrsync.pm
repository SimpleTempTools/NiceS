package NS::Util::Mrsync;

=head1 NAME

NS::Util::Mrsync - Replicate data via phased rsync

=head1 SYNOPSIS

 use NS::Util::Mrsync;

 my $mrsync = NS::Util::Mrsync->new
 ( 
     src => \@src_hosts,
     dst => \@dst_hosts,
     sp => $src_path,
...
sub run
{
    ...
    $NS::Util::Phasic::MAX = delete $run{max} if $run{max};
