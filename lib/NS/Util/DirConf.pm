package NS::Util::DirConf;

=head1 NAME

NS::Util::DirConf - Interface module: directory configuration with a YAML file.

=head1 SYNOPSIS

 use base NS::Util::DirConf;

 sub define { qw( log code ) };

 my $conf = NS::Util::DirConf->new( '/conf/file' );
